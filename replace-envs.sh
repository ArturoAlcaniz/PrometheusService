...
PRODUCTS_CONTAINER_NAME=$PRODUCTS_CONTAINER_NAME
PRODUCTS_CONTAINER_PORT=$PRODUCTS_CONTAINER_PORT
...
sed -i "s/\${PRODUCTS_CONTAINER_NAME}/$PRODUCTS_CONTAINER_NAME/g" /app/PrometheusService/prometheus/prometheus.yml
sed -i "s/\${PRODUCTS_CONTAINER_PORT}/$PRODUCTS_CONTAINER_PORT/g" /app/PrometheusService/prometheus/prometheus.yml